...
DEBUG Still waiting for the Kubernetes API: Get https://api.ocp46.example.local:644 resource 3/version?timeout=32s: EOF                                                          resource 
DEBUG Still waiting for the Kubernetes API: Get https://api.ocp46.example.local:6443/version?timeout=32s: EOF 3/version?timeout=32s: EOF                                                         3/version?timeout=32s: EOF 
API v1.19.0+3b01205 up
...
csr-8557v   27m   kubernetes.io/kubelet-serving                 system:node:m1.ocp46.example.local                                          Approved,Issued
...
csr-8v6ns   27m   kubernetes.io/kubelet-serving                 system:node:m3.ocp46.example.local                                          Approved,Issued
csr-frwfk   1s    kubernetes.io/kubelet-serving                 system:node:w1.ocp46.example.local                                          Pending
...
csr-qqh7s   27m   kubernetes.io/kubelet-serving                 system:node:m2.ocp46.example.local                                          Approved,Issued
...
csr-8cjss   13m   kubernetes.io/kube-apiserver-client-kubelet   system:serviceaccount:openshift-machine-config-operator:node-bootstrapper   Approved,Issued
csr-8v6ns   27m   kubernetes.io/kubelet-serving                 system:node:m3.ocp46.example.local                                          Approved,Issued
csr-frwfk   22s   kubernetes.io/kubelet-serving                 system:node:w1.ocp46.example.local                                          Approved,Issued
csr-hpw9z   15s   kubernetes.io/kubelet-serving                 system:node:w2.ocp46.example.local                                          Pending
...
csr-8557v   28m   kubernetes.io/kubelet-serving                 system:node:m1.ocp46.example.local                                          Approved,Issued
...
csr-8v6ns   28m   kubernetes.io/kubelet-serving                 system:node:m3.ocp46.example.local                                          Approved,Issued
csr-frwfk   44s   kubernetes.io/kubelet-serving                 system:node:w1.ocp46.example.local                                          Approved,Issued
csr-hpw9z   37s   kubernetes.io/kubelet-serving                 system:node:w2.ocp46.example.local                                          Approved,Issued
csr-nnzww   13m   kubernetes.io/kube-apiserver-client-kubelet   system:serviceaccount:openshift-machine-config-operator:node-bootstrapper   Approved,Issued
csr-qqh7s   28m   kubernetes.io/kubelet-serving                 system:node:m2.ocp46.example.local                                          Approved,Issued
...
m1.ocp46.example.local   Ready    master   31m     v1.19.0+3b01205
m2.ocp46.example.local   Ready    master   31m     v1.19.0+3b01205
m3.ocp46.example.local   Ready    master   31m     v1.19.0+3b01205
w1.ocp46.example.local   Ready    worker   4m13s   v1.19.0+3b01205
w2.ocp46.example.local   Ready    worker   4m5s    v1.19.0+3b01205
[root@bastion openshift]# 
```
