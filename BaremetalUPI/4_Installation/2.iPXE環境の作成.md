...
```
:bootstrap  
kernel http://bs.ocp47.example.localdomain/rhcos-4.7.0-x86_64-live-kernel-x86_64 ip=dhcp rd.neednet=1 console=tty0 console=ttyS0 coreos.inst=yes coreos.inst.install_dev=sda initrd=rhcos-4.7.0-x86_64-live-initramfs.x86_64.img  coreos.live.rootfs_url=http://bs.ocp47.example.localdomain/rhcos-4.7.0-x86_64-live-rootfs.x86_64.img coreos.inst.ignition_url=http://bs.ocp47.example.localdomain/bootstrap.ign
initrd http://bs.ocp47.example.localdomain/rhcos-4.7.0-x86_64-live-initramfs.x86_64.img
boot
```
...
```
:master
kernel http://bs.ocp47.example.localdomain/rhcos-4.7.0-x86_64-live-kernel-x86_64 ip=dhcp rd.neednet=1 console=tty0 console=ttyS0 coreos.inst=yes coreos.inst.install_dev=sda initrd=rhcos-4.7.0-x86_64-live-initramfs.x86_64.img coreos.live.rootfs_url=http://bs.ocp47.example.localdomain/rhcos-4.7.0-x86_64-live-rootfs.x86_64.img coreos.inst.ignition_url=http://bs.ocp47.example.localdomain/master.ign
initrd http://bs.ocp47.example.localdomain/rhcos-4.7.0-x86_64-live-rootfs.x86_64.img
boot
```
...
```
:worker　  
kernel http://bs.ocp47.example.localdomain/rhcos-4.7.0-x86_64-live-kernel-x86_64 ip=dhcp rd.neednet=1 console=tty0 console=ttyS0 coreos.inst=yes coreos.inst.install_dev=sda initrd=rhcos-4.7.0-x86_64-live-initramfs.x86_64.img coreos.live.rootfs_url=http://bs.ocp47.example.localdomain/rhcos-4.7.0-x86_64-live-rootfs.x86_64.img coreos.inst.ignition_url=http://bs.ocp47.example.localdomain/worker.ign
initrd http://bs.ocp47.example.localdomain/rhcos-4.7.0-x86_64-live-initramfs.x86_64.img
boot
```
