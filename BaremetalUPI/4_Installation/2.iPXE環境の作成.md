...
kernel http://192.2.0.101/rhcos-4.7.0-x86_64-live-kernel-x86_64 ip=dhcp rd.neednet=1 console=tty0 console=ttyS0 coreos.inst=yes coreos.inst.install_dev=sda initrd=rhcos-4.7.0-x86_64-live-initramfs.x86_64.img  coreos.live.rootfs_url=http://192.2.0.101/rhcos-4.7.0-x86_64-live-rootfs.x86_64.img coreos.inst.ignition_url=http://192.2.0.101/bootstrap.ign
initrd http://192.2.0.101/rhcos-4.7.0-x86_64-live-initramfs.x86_64.img
boot

:master　  # ここはインストールしたい OS毎に異なる
kernel rhcos-4.7.0-x86_64-live-kernel-x86_64 ip=dhcp rd.neednet=1 console=tty0 console=ttyS0 coreos.inst=yes coreos.inst.install_dev=sda initrd=rhcos-4.7.0-x86_64-live-initramfs.x86_64.img coreos.live.rootfs_url=http://192.2.0.101/rhcos-4.7.0-x86_64-live-rootfs.x86_64.img coreos.inst.ignition_url=http://192.2.0.101/master.ign
initrd http://192.2.0.101/rhcos-4.7.0-x86_64-live-rootfs.x86_64.img
boot

:worker　  # ここはインストールしたい OS毎に異なる
kernel http://192.2.0.101/rhcos-4.7.0-x86_64-live-kernel-x86_64 ip=dhcp rd.neednet=1 console=tty0 console=ttyS0 coreos.inst=yes coreos.inst.install_dev=sda initrd=rhcos-4.7.0-x86_64-live-initramfs.x86_64.img coreos.live.rootfs_url=http://192.2.0.101/rhcos-4.7.0-x86_64-live-rootfs.x86_64.img coreos.inst.ignition_url=http://192.2.0.101/worker.ign
initrd http://192.2.0.101/rhcos-4.7.0-x86_64-live-initramfs.x86_64.img
boot
...
の3つのファイル名が、記述内に埋め込まれています。

ingition ファイルである `bootstrap.ign` を参照している事に注意します。
